...
_STRINGS = {
    "zh": {
        ...
        "kimi_hooks_synced": "已写入 Kimi Code Stop 心跳 Hook；在 Windows Terminal 中按 Ctrl+Alt+K 可在同窗口打开监视窗格",
        "kimi_hooks_removed": "已移除 Token Tracker 的 Kimi Code Hooks",
        "kimi_watch_action_synced": "已写入 Windows Terminal Ctrl+Alt+K 同窗口分屏快捷键",
        "kimi_watch_action_removed": "已移除 Windows Terminal Kimi 监视窗格快捷键",
    ...
    "en": {
        ...
        "agent_filter_conflict": "--claude / --codex / --kimi are mutually exclusive; please pick one",
        ...
        "kimi_hooks_synced": "Kimi Code Stop heartbeat hook written; use Ctrl+Alt+K in Windows Terminal for a same-window watch pane",
        "kimi_hooks_removed": "Token Tracker Kimi Code hooks removed",
        "kimi_watch_action_synced": "Windows Terminal Ctrl+Alt+K same-window pane shortcut installed",
        "kimi_watch_action_removed": "Windows Terminal Kimi watcher pane shortcut removed",
