...
_STRINGS = {
    "zh": {
        ...
        "no_agent_detected": "未检测到 Claude Code、Codex 或 Kimi Code",
    ...
    "en": {
        ...
        "wizard_restart": "Restart Claude Code / Codex / Kimi Code to take effect",
        ...
        # --- hooks.py ---
        "no_agent_install": "Claude Code, Codex or Kimi Code not detected, please install one first",
        ...
        "no_agent_detected": "Claude Code, Codex or Kimi Code not detected",
